...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_T = 19,                         /* T  */
  YYSYMBOL_num = 20,                       /* num  */
  YYSYMBOL_pidentifier = 21,               /* pidentifier  */
  ...
  YYSYMBOL_proc_head = 44,                 /* proc_head  */
  YYSYMBOL_proc_call = 45,                 /* proc_call  */
  YYSYMBOL_declarations = 46,              /* declarations  */
  YYSYMBOL_args_decl = 47,                 /* args_decl  */
...
{
       0,    83,    83,    91,   123,   155,   161,   166,   174,   177,
     183,   196,   207,   214,   225,   232,   235,   246,   260,   267,
     311,   315,   319,   323,   330,   337,   344,   351,   361,   366,
     374,   375,   387,   399,   444,   500,   559,   578,   603,   623,
     644,   658,   675,   698,   707,   731,   756
};
#endif
...
static const char *const yytname[] =
{
  ...
  "ENDWHILE", "REPEAT", "UNTIL", "READ", "WRITE", "T", "num",
  "pidentifier", "SEMICOLON", "COMMA", "COLON", "EQUAL", "LPAR", "RPAR",
  "LSPAR", "RSPAR", "PLUS", "MINUS", "SLASH", "ASTERISK", "PERCENT",
  "NEGATION", "MORE", "LESS", "$accept", "program_all", "procedures",
...
{
     -22,     8,    28,   -22,    -8,    17,   -22,    -4,    30,     6,
      -5,     7,   168,    29,    -3,    42,   -22,    25,   168,     1,
      51,    51,   168,    45,    51,    11,    89,   -22,    56,    53,
       9,   168,    59,   -22,    21,   -22,   105,   168,   -22,    54,
      72,   -18,   -22,    70,   141,    74,    76,    78,    55,   -22,
     -22,   -22,    75,    73,   113,    77,    82,   -22,   -22,   121,
     168,    51,    83,     5,    35,   168,    51,   -22,   -22,   -22,
      46,    85,    86,    51,   -22,   -22,    92,   -22,   -22,   133,
     -22,    51,    51,   -22,    51,   -22,   152,    94,    97,   -22,
     -22,   -22,   102,   161,   103,   168,   -22,   -22,   -22,   -22,
     -22,   -22,   -22,   -22,    51,    51,    51,    51,    51,   -22,
...
static const yytype_int8 yydefact[] =
{
       ...
       8,    15,     0,     0,     0,    20,     0,    24,     4,     0,
       0,     0,     0,     0,     0,     0,     0,    16,    17,    29,
       0,     0,     0,     0,    23,     6,     0,    25,     3,     0,
      36,     0,     0,    38,     0,    39,     0,     0,     0,    19,
      45,    46,     0,    30,     0,     0,    12,    37,    40,    41,
      13,    14,    28,    10,     0,     0,     0,     0,     0,    21,
       0,    31,    32,    34,    33,    35,    11
};
...
{
     -22,   -22,   -22,   -22,    14,   -21,   -22,   -22,   124,   -22,
     -22,   -22,   -12,   -14,   -20
};
...
{
      42,    42,    31,    45,    42,    50,    37,    61,     3,    43,
      46,    12,    18,     7,    15,    50,    16,    62,    63,    64,
      32,     9,    10,    50,    32,    38,    39,    13,    13,    53,
      82,     4,    36,    50,    11,     5,    44,    47,    50,    48,
      56,    42,    57,    42,    42,    54,    42,    80,    34,    83,
      85,    59,    35,    42,    87,    38,    39,    30,    50,    93,
      84,    42,    42,    33,    42,    50,    39,    97,    98,    88,
      99,    38,    39,    89,    79,    71,    72,    52,    51,    86,
      55,    60,    48,    65,    42,    42,    42,    42,    42,    50,
     111,   112,   113,   114,   115,    49,    67,    20,    68,    69,
      73,    21,    74,    77,    22,    76,    23,    24,    81,   110,
      25,    58,    94,    20,    90,    91,   101,    21,   102,    75,
      22,    20,    23,    24,   103,    21,    25,    78,    22,    20,
      23,    24,   109,    21,    25,    19,    22,     0,    23,    24,
       0,    20,    25,    95,    96,    21,     0,     0,    22,    20,
      23,    24,     0,    21,    25,     0,    22,    66,    23,    24,
      20,     0,    25,     0,    21,     0,   100,    22,    20,    23,
      24,   116,    21,    25,     0,    22,    20,    23,    24,     0,
      21,    25,     0,    22,     0,    23,    24,     0,     0,    25,
       0,   104,   105,   106,   107,   108
};

static const yytype_int8 yycheck[] =
{
      20,    21,     5,    23,    24,    26,     5,    25,     0,    21,
      24,     5,     5,    21,    19,    36,    21,    35,    36,    37,
      23,     4,    26,    44,    23,    20,    21,    21,    21,    20,
      25,     3,    18,    54,     4,     7,    22,    26,    59,    28,
      19,    61,    21,    63,    64,    31,    66,    61,    23,    63,
      64,    37,    27,    73,    66,    20,    21,    28,    79,    73,
      25,    81,    82,    21,    84,    86,    21,    81,    82,    23,
      84,    20,    21,    27,    60,    20,    21,    24,    22,    65,
      21,     9,    28,    13,   104,   105,   106,   107,   108,   110,
     104,   105,   106,   107,   108,     6,    22,     8,    22,    21,
      25,    12,    29,    21,    15,    28,    17,    18,    25,    95,
      21,     6,    20,     8,    29,    29,    22,    12,    21,     6,
      15,     8,    17,    18,    22,    12,    21,     6,    15,     8,
      17,    18,    29,    12,    21,    11,    15,    -1,    17,    18,
      -1,     8,    21,    10,    11,    12,    -1,    -1,    15,     8,
      17,    18,    -1,    12,    21,    -1,    15,    16,    17,    18,
       8,    -1,    21,    -1,    12,    -1,    14,    15,     8,    17,
      18,    11,    12,    21,    -1,    15,     8,    17,    18,    -1,
      12,    21,    -1,    15,    -1,    17,    18,    -1,    -1,    21,
      -1,    30,    31,    32,    33,    34
};
...
{
       0,    39,    40,     0,     3,     7,    41,    21,    44,     4,
      26,     4,     5,    21,    46,    19,    21,    47,     5,    46,
       8,    12,    15,    17,    18,    21,    42,    43,    45,    52,
      28,     5,    23,    21,    23,    27,    42,     5,    20,    21,
      50,    51,    52,    50,    42,    52,    51,    26,    28,     6,
      43,    22,    24,    20,    42,    21,    19,    21,     6,    42,
       9,    25,    35,    36,    37,    13,    16,    22,    22,    21,
      48,    20,    21,    25,    29,     6,    28,    21,     6,    42,
      51,    25,    25,    51,    25,    51,    42,    50,    23,    27,
      29,    29,    49,    51,    20,    10,    11,    51,    51,    51,
      14,    22,    21,    22,    30,    31,    32,    33,    34,    29,
      42,    51,    51,    51,    51,    51,    11
};
...
#line 196 "kompilator.y"
                                                     {
        generatedLines += 2;
        int len6 = countLines(yyvsp[-1]);
        int addr6 = generatedLines - len6;

        yyval = yyvsp[-5];
        yyval += "JPOS " + std::to_string(addr6) + "\n";
        yyval += incrementJumps(yyvsp[-3]);
        yyval += "JUMP " + std::to_string(generatedLines) + "\n";
        yyval += incrementJumps(incrementJumps(yyvsp[-1]));
    }
...
#line 207 "kompilator.y"
        ...
        yyval = yyvsp[-3];
        yyval += "JPOS " + std::to_string(generatedLines) + "\n";
        yyval += incrementJumps(yyvsp[-1]);
    }
#line 1665 "kompilator_y.cpp"
    break;

  case 13: /* command: WHILE condition DO commands ENDWHILE  */
#line 214 "kompilator.y"
                                           {
        int loopBegin = generatedLines - countLines(yyvsp[-3]) - countLines(yyvsp[-1]);
        generatedLines += 2;

        yyval = "#WHILE" + std::to_string(loopBegin) + "\n#CONDITION\n" + yyvsp[-3];
        yyval += "#ENDCONDITION\n";
        yyval += "JPOS " + std::to_string(generatedLines) + "\n";
        yyval += incrementJumps(yyvsp[-1]);
        yyval += "JUMP " + std::to_string(loopBegin) + "\n";
        yyval += "#ENDWHILE\n";
    }
#line 1681 "kompilator_y.cpp"
    break;
...
#line 225 "kompilator.y"
        ...
        yyval += "JPOS " + std::to_string(loopBegin) + "\n";
        generatedLines += 1;
    }
#line 1693 "kompilator_y.cpp"
    break;
...
#line 267 "kompilator.y"
        ...
        for(int j = 0; j < argsVector.size(); j++)
        {
            ...
            generatedLines += insertingNumber("a", sourceAddr, &yyval);
            generatedLines += insertingNumber(r1, targetAddr, &yyval);
            yyval += "STORE " + r1 + "\n";
        }

        generatedLines += insertingNumber(r1, returnAddr, &yyval);
        yyval += "RST " + r2 + "\n";
        yyval += "INC " + r2 + "\n";
        yyval += "SHL " + r2 + "\n";
        yyval += "SHL " + r2 + "\n";
        ...
        yyval += "ADD " + r2 + "\n";
        yyval += "STORE " + r1 + "\n";
        yyval += "JUMP " + std::to_string(procAddr) + "\n";
        generatedLines += 8;
...
#line 399 "kompilator.y"
        ...
        yyval = yyvsp[-2] + yyvsp[0];
        yyval += "#MNOŻENIE " + std::to_string(generatedLines) + "\n";
        yyval += "GET " + b + "\n";
        yyval += "JZERO " + std::to_string(generatedLines + 32) + "\n";
        yyval += "GET " + c + "\n";
        yyval += "JPOS " + std::to_string(generatedLines + 6) + "\n";
        yyval += "RST " + b + "\n";
        yyval += "JUMP " + std::to_string(generatedLines + 32) + "\n";
        yyval += "SUB " + b + "\n";
        yyval += "JZERO " + std::to_string(generatedLines + 14) + "\n";
        yyval += "GET " + b + "\n";
        yyval += "PUT " + d + "\n";
        yyval += "GET " + c + "\n";
        yyval += "PUT " + b + "\n";
        ...
        yyval += "GET " + c + "\n";
        yyval += "DEC a\n";
        yyval += "JZERO " + std::to_string(generatedLines + 29) + "\n";
        yyval += "GET " + c + "\n";
        yyval += "SHR " + c + "\n";
        yyval += "SHL " + c + "\n";
        yyval += "SUB " + c + "\n";
        yyval += "JZERO " + std::to_string(generatedLines + 26) + "\n";
        yyval += "GET " + b + "\n";
        yyval += "ADD " + d + "\n";
        yyval += "PUT " + d + "\n";
        yyval += "SHL " + b + "\n";
        yyval += "SHR " + c + "\n";
        yyval += "JUMP " + std::to_string(generatedLines + 15) + "\n";
        yyval += "GET " + b + "\n";
        yyval += "ADD " + d + "\n";
        yyval += "PUT " + b + "\n";
...
#line 444 "kompilator.y"
        ...
        yyval += "RST " + d + "\n";
        yyval += "GET " + b + "\n";
        yyval += "JZERO " + std::to_string(generatedLines + 40) + "\n";
        yyval += "PUT " + d + "\n";
        yyval += "RST " + b + "\n";
        yyval += "GET " + c + "\n"; 
        yyval += "DEC a\n"; 
        ...
        yyval += "GET " + c + "\n"; 
        yyval += "SUB " + b + "\n"; 
        yyval += "JPOS " + std::to_string(generatedLines + 40) + "\n";
        yyval += "RST " + e + "\n"; 
        yyval += "GET " + c + "\n";
        yyval += "SUB " + b + "\n";
        yyval += "JPOS " + std::to_string(generatedLines + 21) + "\n";
        yyval += "SHL " + c + "\n"; 
        yyval += "INC " + e + "\n";
        yyval += "JUMP " + std::to_string(generatedLines + 15) + "\n";
        yyval += "SHR " + c + "\n"; 
        ...
        yyval += "GET " + c + "\n";
        yyval += "SUB " + b + "\n";
        yyval += "JPOS " + std::to_string(generatedLines + 27) + "\n";
        yyval += "INC " + d + "\n"; 
        yyval += "GET " + b + "\n"; 
        yyval += "SUB " + c + "\n"; 
        yyval += "PUT " + b + "\n"; 
        yyval += "JUMP " + std::to_string(generatedLines + 27) + "\n";
...
#line 2098 "kompilator_y.cpp"
    break;

  case 36: /* condition: value EQUAL value  */
#line 559 "kompilator.y"
                      {
        std::string r3 = lastUsedRegister.top();
        lastUsedRegister.pop();
        std::string r1 = lastUsedRegister.top();
...
#line 2122 "kompilator_y.cpp"
    break;

  case 37: /* condition: value NEGATION EQUAL value  */
#line 578 "kompilator.y"
                                 {
        std::string r4 = lastUsedRegister.top();
        lastUsedRegister.pop();
        std::string r1 = lastUsedRegister.top();
...
#line 2152 "kompilator_y.cpp"
    break;

  case 38: /* condition: value MORE value  */
#line 603 "kompilator.y"
                       {
        std::string r3 = lastUsedRegister.top();
        lastUsedRegister.pop();
        std::string r1 = lastUsedRegister.top();
...
#line 2177 "kompilator_y.cpp"
    break;

  case 39: /* condition: value LESS value  */
#line 623 "kompilator.y"
                       {
        std::string r3 = lastUsedRegister.top();
        lastUsedRegister.pop();
        std::string r1 = lastUsedRegister.top();
...
#line 2222 "kompilator_y.cpp"
    break;

  case 41: /* condition: value LESS EQUAL value  */
#line 658 "kompilator.y"
                             {
        std::string r4 = lastUsedRegister.top();
        lastUsedRegister.pop();
        std::string r1 = lastUsedRegister.top();
...
#line 2241 "kompilator_y.cpp"
    break;

  case 42: /* value: num  */
#line 675 "kompilator.y"
        {
        int x = stoi(yyvsp[0]);
...
#line 2269 "kompilator_y.cpp"
    break;

  case 43: /* value: identifier  */
#line 698 "kompilator.y"
                 {
        yyval = yyvsp[0];
...
#line 2280 "kompilator_y.cpp"
    break;

  case 44: /* identifier: pidentifier  */
#line 707 "kompilator.y"
...
#line 2309 "kompilator_y.cpp"
    break;

  case 45: /* identifier: pidentifier LSPAR num RSPAR  */
#line 731 "kompilator.y"
                                  { 
        std::string r = takeFirstAvailableRegisterNotA();
